...
export class LeasingListComponent implements OnInit {
    ...
    displayedColumns: string[] = ['id','game','customer','leasing_date','end_date','action'];
    ...
    // crea nuevo préstamo con un cuadro vacio
    ...
    // busqueda por juego cliente o fecha
    ...
    // borrado de filtro de búsquedas
    ...
    // carga la pagina con los datos paginados
